...
public interface WeatherSoap {
     ...
     * 
     * @return
     *     returns fr.treeptik.wsimport.ArrayOfWeatherDescription
     */
    ...
    @RequestWrapper(localName = "GetWeatherInformation", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fr.treeptik.wsimport.GetWeatherInformation")
    @ResponseWrapper(localName = "GetWeatherInformationResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fr.treeptik.wsimport.GetWeatherInformationResponse")
     ...
     * @param zip
     * @return
     *     returns fr.treeptik.wsimport.ForecastReturn
     */
    ...
    @RequestWrapper(localName = "GetCityForecastByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fr.treeptik.wsimport.GetCityForecastByZIP")
    @ResponseWrapper(localName = "GetCityForecastByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fr.treeptik.wsimport.GetCityForecastByZIPResponse")
     ...
     * @param zip
     * @return
     *     returns fr.treeptik.wsimport.WeatherReturn
     */
    ...
    @RequestWrapper(localName = "GetCityWeatherByZIP", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fr.treeptik.wsimport.GetCityWeatherByZIP")
    @ResponseWrapper(localName = "GetCityWeatherByZIPResponse", targetNamespace = "http://ws.cdyne.com/WeatherWS/", className = "fr.treeptik.wsimport.GetCityWeatherByZIPResponse")
