 ...
 * 
 */
@WebServiceClient(name = "ManagerWebServiceService", targetNamespace = "http://webservice.treeptik.fr/", wsdlLocation = "http://localhost:8080/template-JSF-CDI-EJB/ManagerWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MANAGERWEBSERVICESERVICE_QNAME = new QName("http://webservice.treeptik.fr/", "ManagerWebServiceService");
    ...
    public ManagerWebService getManagerWebServicePort() {
        return super.getPort(new QName("http://webservice.treeptik.fr/", "ManagerWebServicePort"), ManagerWebService.class);
    }
    ...
    public ManagerWebService getManagerWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.treeptik.fr/", "ManagerWebServicePort"), ManagerWebService.class, features);
    }
